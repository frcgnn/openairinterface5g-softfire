...
typedef struct {
  ...
  //<Add:Giannone>
  double myUE_start_x; /*!< The start value of UE X coordinate */
  double myUE_start_y; /*!< The start of value of UE Y coordinate */
  double myDistance;   /*!<The reference distance value to avoid X and Y coordinate change after some distance */
  double myJourneytime_next; /*!<The reference distance value to avoid X and Y coordinate change after some journey time */
  //</Add:Giannone>
