...
void init_oai_emulation(void)
{
  ...
  oai_emulation.topology_config.mobility.UE_mobility.UE_moving_dynamics.min_speed_mps = 1.0;//0.1;
  oai_emulation.topology_config.mobility.UE_mobility.UE_moving_dynamics.max_speed_mps = 1.0;
  oai_emulation.topology_config.mobility.UE_mobility.UE_moving_dynamics.min_sleep_ms = 0.1;
  oai_emulation.topology_config.mobility.UE_mobility.UE_moving_dynamics.max_sleep_ms = 0.1; //5.0;
  oai_emulation.topology_config.mobility.UE_mobility.UE_moving_dynamics.min_journey_time_ms = 10.0; //0.1;
  ...
  oai_emulation.topology_config.mobility.eNB_mobility.eNB_initial_distribution.selected_option = "fixed";
  oai_emulation.topology_config.mobility.eNB_mobility.fixed_eNB_distribution.pos_x = 50;
  oai_emulation.topology_config.mobility.eNB_mobility.fixed_eNB_distribution.pos_y = 250;
...
int ocg_config_topo(void)
{
  ...
  for(i=0; i < MAX_NUM_NODE_TYPES; i++) {
    ...
    // init values
    omg_param_list[i].min_speed = 1.0; //0.1;
    omg_param_list[i].max_speed = 1.0;
    omg_param_list[i].min_journey_time = 10.0; //0.1;
    ...
    omg_param_list[i].max_sleep = 0.1;//8.0;
    ...
    if(i==eNB) {
      ...
      LOG_I(OMG,"eNB mobility model is (%s, %d)\n",
            oai_emulation.topology_config.mobility.eNB_mobility.eNB_mobility_type.selected_option,oai_emulation.info.omg_model_enb);
      ...
      //<Add:Giannone>
        omg_param_list[i].myUE_start_x       = 250.0;
        omg_param_list[i].myUE_start_y       = 200.0;
        omg_param_list[i].myDistance         = 300.0;
        omg_param_list[i].myJourneytime_next = 300.0;
      //</Add:Giannone>
